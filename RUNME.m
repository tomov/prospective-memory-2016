...
if experiment == 1
    ...
    startpar = [1  0.35   1    0.3, ...     % focal, low emph     % exp1_v16, exp2_v19
      ...
      startpar([2 4 6 8 10 12 14 16 22]) = [0.5729    0.5401    0.7372    0.6057    0.8686    0.8358    0.9342  0.8883    0.6058 / 1000];
      startpar([2 4 6 8 10 12 14 16 22]) = [0.4527    0.2526    0.5876    0.3368    0.7560    0.7139    0.7885  0.6989    0.3368 / 1000];
      startpar([2 4 6 8 10 12 14 16 22]) = [0.3298    0.3403    0.5654    0.4345    0.8115    0.7067    0.8480  0.7821    0.3769 / 1000];
