...
ylabel('PM Hit Rate (%)');
plot_all_conditions_brewer(empirical_stats(:, [1:3 10 11]), 50, 100, 1, 0, true);
...
subplot(4, 2, 4);
plot_all_conditions_brewer(simulation_stats(:, [1:3 4 5]), 650, 850, RT_slope, RT_intercept, false);
