...
fprintf(['This effect was entirely driven by commission errors ', ...
    'which were relatively high in the first block (M = %.2f +- %.2f %%) ', ...
    'but gradually decayed and eventually disappeared in the last block (M = %.2f +- %.2f %%; first vs. last block, F = %f, p = %f).\n'], ...
